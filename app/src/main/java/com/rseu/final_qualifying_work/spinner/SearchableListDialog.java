package com.rseu.final_qualifying_work.spinner;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        button = rootView.findViewById(R.id.searchable_button);
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.spinner_item,
                items);
